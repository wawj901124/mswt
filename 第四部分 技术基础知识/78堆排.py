...
def heap_sort(lst):
    ...
    print("__________________创建最大堆_______________________")
    #创建最大堆
    ...
    print("__________________排序过程_______________________")
    #堆排序
...
print("heap_sort(alist):%s" % heap_sort(alist))